...
//arrow function
const print_population = (arr_ind,arr_place,arr_popu) => console.log(`${arr_place[arr_ind]} has a population of ${arr_popu[arr_ind]} million .`)
...
const mixed_array = ['Kartik',1999,'Nagrota Bagwan', 2023-1999,hobbies,3.14]
...
console.log("After pushing; we have now  ",len_places,"values :",places,poplulation_million)
...
console.log("POP: the popped out place which was end of the array is : ",places.pop())
...
console.log("SHIFT: the removed place which was at starting of the array is : ",places.shift())
...
console.log("Population of India in Millions is  ",poplulation_million[places.indexOf("India")])
