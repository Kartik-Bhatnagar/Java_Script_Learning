...
const dob = {
    ...
    setMonth :function(m){this.month=m},
    setYear : function(y){this.year=y}
}
...
function totDays(){
    ...
    if( dob.year == todayDate.year){
        let daysDiff=(revTotDays(dob.date,dob.month,dob.year)-
        ...
        let totDaysPassed = (revTotDays(dob.date,dob.month,dob.year)+365*(yearDifference)+leapYearCount+
